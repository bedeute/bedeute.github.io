 ...
 */
function(t){"use strict";t(function(){}),t("#navbar-lite").affix({offset:{top:450}});t("body").scrollspy({target:"#nav"}),t("#nav .navbar-nav li>a").click(function(){var e=t(this).attr("href"),n=t(e).offset().top-140;t("body,html").animate({scrollTop:n},700)})}(jQuery);